...
Install Cisco Packet Tracer (free via Cisco Networking Academy)

Extract the repository

Open Packet Tracer → File → Open → select any .pkt file

Start with *-start.pkt, validate using *-solution.pkt
